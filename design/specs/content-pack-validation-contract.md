...
| `FW-VAL-D-011` | **3D-asset commercial-rights manifest complete** | `Content.Validator` | `FW-VAL-D-011.pack` — pack containing AI-generated 3D character asset whose manifest omits `commercial_rights_proof` or `plan_license_tier` field | `[FW-VAL-D-011] Asset <asset_path> in pack <pack_id> omits commercial-rights manifest fields (generator / plan_license_tier / prompt_source_refs / human_edit_steps / commercial_rights_proof / generated_asset_hash). Required for every AI-generated 3D asset before RC bundle; see design/3d-pipeline.md §Licensing requirements + SETUP.md §7.` |
