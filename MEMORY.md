...
> Updated: 2026-05-13 | Phase: T1 First Match (T1-1 / T1-2a / T1-2b-i / T1-2b-ii / T1-2b-iii-a / T1-2b-iii-b closed; **T1-2b-iii-c DONE** — BT site bindings + personality bias + utility-scored leaves; GK FSM now actually transitions; canonical hash REBASELINED per ADR-0012 trigger #1)
...
(none — T1-2b-iii-c closed. `/next` picks T1-2b-iii-d: PlayerSeparation + manual eyeball acceptance gate.)
